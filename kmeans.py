...
class KMeans(base.ClusterMixin, base.BaseEstimator):
    def __init__(self, n_clusters, initialize='k-means++', max_iter=1000):
    ...
    def fit(self, x):
        self.n_iter_ = 0
        self.centroids = kme.initialization(self.n_clusters, self.initialize, x)
        ...
        for i in range(9):
            n_iter = 0
            centroidsi = kme.initialization(self.n_clusters, self.initialize, x)
